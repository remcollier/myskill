...
public class SinglePlayerFunctionaility {
    ...
    private SinglePlayerApi singleplayerApi = new SinglePlayerApi();
    private Score quizScore = new Score();


    public SinglePlayerFunctionaility() {
    }
    ...
    public String getToken(String userID) {
        ...
        String response = singleplayerApi.sendToken(tokenRequest);
    ...
    public void sendScore(Long quizId, String accountID, int finalScore) {
        ...
        singleplayerApi.sendScore(scoreRequest);
    }
